...
export default function Home() {
  ...
  return (
    <div className="min-h-screen relative">
      {/* Fullscreen interactive undersea 3D background */}
      <UnderseaBackground />

      {/* Navigation */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-neutral-0/80 backdrop-blur-md border-b border-neutral-200">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            <motion.div
              ...
              className="inline-flex items-center space-x-2 bg-blue-50/90 text-blue-700 px-4 py-2 rounded-full text-sm font-medium mb-8"
            >
            ...
            <motion.h1 
              ...
              className="text-5xl md:text-6xl font-bold text-neutral-50 drop-shadow mb-6 leading-tight"
            >
            ...
            <motion.p 
              ...
              className="text-xl text-neutral-100/90 mb-12 max-w-2xl mx-auto leading-relaxed"
            >
      ...
      {activeSection && (
        <motion.section
          ...
          className="relative z-10 py-20 px-6 bg-neutral-50/80 backdrop-blur-sm"
        >
          <div className="max-w-7xl mx-auto">
              ...
              {activeSection === 'citizens' ? (
                <>
                  <motion.div 
                    ...
                    className="bg-neutral-0/90 p-8 rounded-2xl shadow-soft"
                  >
      ...
      <section id="features" className="relative z-10 py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-neutral-50 drop-shadow mb-4">
              Why Choose AegisFlood?
            </h2>
            <p className="text-xl text-neutral-100/90 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-neutral-50 mb-3">Proven Reliability</h3>
              <p className="text-neutral-100/90">99.9% uptime with redundant systems ensuring continuous protection for your community.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-neutral-50 mb-3">Lightning Fast</h3>
              <p className="text-neutral-100/90">Sub-second alert delivery with optimized infrastructure for critical emergency situations.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-neutral-50 mb-3">Global Scale</h3>
              <p className="text-neutral-100/90">Trusted by communities worldwide with multi-language support and regional customization.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Footer */}
      <footer className="relative z-10 bg-neutral-900/90 text-neutral-0 py-12 px-6">
