...
const translations: Record<Language, Record<string, string>> = {
	en: {
		...
		'alerts.searchPlaceholder': 'Search alerts by title, description, or location...',
		'alerts.status': 'Status',
		'alerts.status_all': 'All',
		'alerts.status_active': 'Active',
		'alerts.status_resolved': 'Resolved',
		'alerts.status_expired': 'Expired',
		'alerts.severity': 'Severity',
		'alerts.severity_all': 'All',
		...
		'alerts.emptyDesc': 'Try adjusting your search or filter criteria',
		'alerts.timestamp': 'Updated',
	...
	hi: {
		...
		'alerts.searchPlaceholder': 'शीर्षक, विवरण या स्थान के आधार पर अलर्ट खोजें...',
		'alerts.status': 'स्थिति',
		'alerts.status_all': 'सभी',
		'alerts.status_active': 'सक्रिय',
		'alerts.status_resolved': 'सुलझा',
		'alerts.status_expired': 'समाप्त',
		'alerts.severity': 'गंभीरता',
		'alerts.severity_all': 'सभी',
		'alerts.severity_low': 'कम',
		'alerts.severity_medium': 'मध्यम',
		'alerts.severity_high': 'उच्च',
		'alerts.severity_critical': 'गंभीर',
		'alerts.affectedAreas': 'प्रभावित क्षेत्र',
		'alerts.viewDetails': 'विवरण देखें',
		'alerts.viewOnMap': 'मानचित्र पर देखें',
		'alerts.emptyTitle': 'कोई अलर्ट नहीं मिला',
		'alerts.emptyDesc': 'अपनी खोज या फ़िल्टर मानदंड समायोजित करने का प्रयास करें',
		'alerts.timestamp': 'अपडेट',

		// App common
		'app.community': 'समुदाय',
		'app.logout': 'लॉगआउट',
	...
	as: {
		...
		'alerts.searchPlaceholder': 'শিৰোনাম, বিৱৰণ বা অৱস্থান অনুসৰি সতৰ্কতা সন্ধান কৰক...',
		'alerts.status': 'অৱস্থা',
		'alerts.status_all': 'সকলো',
		'alerts.status_active': 'সক্ৰিয়',
		'alerts.status_resolved': 'সমাধান',
		'alerts.status_expired': 'মেয়াদউত্তীৰ্ণ',
		'alerts.severity': 'গুৰুত্ব',
		'alerts.severity_all': 'সকলো',
		'alerts.severity_low': 'কম',
		'alerts.severity_medium': 'মধ্যম',
		'alerts.severity_high': 'উচ্চ',
		'alerts.severity_critical': 'গুৰুতৰ',
		'alerts.affectedAreas': 'প্ৰভাৱিত অঞ্চলসমূহ',
		'alerts.viewDetails': 'বিৱৰণ চাওক',
		'alerts.viewOnMap': 'মানচিত্ৰত চাওক',
		'alerts.emptyTitle': 'কোনো সতৰ্কতা পোৱা নগল',
		'alerts.emptyDesc': 'আপোনাৰ সন্ধান বা ফিল্টাৰ প্ৰমাণপত্ৰ সজাই লওক',
		'alerts.timestamp': 'আপডেট',

		// App common
		'app.community': 'কমিউনিটি',
		'app.logout': 'লগআউট',
	...
	ta: {
		...
		'alerts.allClear': 'எல்லாம் தெளிவாக உள்ளது! உங்கள் பகுதியில் செயல்பாட்டில் எச்சரிக்கைகள் எதுவும் இல்லை.',
		'alerts.searchPlaceholder': 'தலைப்பு, விளக்கம் அல்லது இடம் மூலம் எச்சரிக்கைகளைத் தேடவும்...',
		'alerts.status': 'நிலை',
		'alerts.status_all': 'அனைத்து',
		'alerts.status_active': 'செயலில்',
		'alerts.status_resolved': 'தீர்க்கப்பட்டது',
		'alerts.status_expired': 'காலாவதி',
		'alerts.severity': 'தீவிரம்',
		'alerts.severity_all': 'அனைத்து',
		'alerts.severity_low': 'குறைந்த',
		'alerts.severity_medium': 'நடுத்தர',
		'alerts.severity_high': 'உயர்',
		'alerts.severity_critical': 'முக்கிய',
		'alerts.affectedAreas': 'பாதிக்கப்பட்ட பகுதிகள்',
		'alerts.viewDetails': 'விவரங்களை பார்க்க',
		'alerts.viewOnMap': 'வரைபடத்தில் காண்க',
		'alerts.emptyTitle': 'எந்த எச்சரிக்கைகளும் இல்லை',
		'alerts.emptyDesc': 'உங்கள் தேடல் அல்லது வடிகட்டி அளவுகோலை மாற்றிப் பார்க்கவும்',
		'alerts.timestamp': 'புதுப்பிப்பு',
